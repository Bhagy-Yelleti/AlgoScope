  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <p className="text-xs text-slate-500 uppercase tracking-wider pl-1">Algorithm</p>
      ...
      <div className="space-y-3">
        <Tooltip content="The text to search within" position="right" className="w-full">
          <div>
            <p className="text-xs text-slate-500 uppercase tracking-wider mb-1 pl-1">Text</p>
            <input
              value={textInput}
        ...
        <Tooltip content="The pattern to find inside the text" position="right" className="w-full">
          <div>
            <p className="text-xs text-slate-500 uppercase tracking-wider mb-1 pl-1">Pattern</p>
            <input
              value={patternInput}
        ...
        <Tooltip content="Run the visualization" position="top" className="w-full">
          <button
            onClick={onVisualize}
