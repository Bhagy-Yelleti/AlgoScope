...
3. Make your changes.
4. Ensure your code follows the project's style (run `npm run lint` if available).
...
Refer to the [Quick Start](README.md#-quick-start) section in the README for local setup instructions.
